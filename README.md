...
The training data contains target and multi-omics data, target file shoule be the chromatin interactions in ./bedpe format, which is the prior knowledge to train the model. And the multi-omics data for the corresponding cell line should be prepared as mentioned above [Installation](#Installation)
